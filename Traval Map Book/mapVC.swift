...
class mapVC: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if slectedTitle != "" {
            ...
            yer.text = self.slectedTitle
            AciklamaText.text = self.slectedSubtitle
    ...
    @objc func chooseLocation(gestureRecognizer: UILongPressGestureRecognizer) {
        ...
        if gestureRecognizer.state == UIGestureRecognizerState.began {
            ...
            annotation.title = yer.text
            annotation.subtitle = AciklamaText.text
            self.mapView.addAnnotation(annotation)
    ...
    @IBAction func saveBotton(_ sender: Any) {
        ...
        newPlace.setValue(yer.text, forKey: "title")
        newPlace.setValue(AciklamaText.text, forKey: "subtitle")
